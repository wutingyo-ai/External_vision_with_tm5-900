...
def generate_launch_description():
    ...
    if (len(sys.argv) >= 5):
        ...
        while i < len(sys.argv):
            ...
            i = i + 1
    # moveit_config = (
    #     MoveItConfigsBuilder("tm5-900_moveit_config")
    ...
    # Controllers
    controllers_yaml = load_yaml(moveit_config_path, 'config/controllers_servo_test.yaml')
    ...
    parameters=[
        robot_description,
        controllers_yaml,   # ⭐ 你要 load controllers.yaml
    ],
)
